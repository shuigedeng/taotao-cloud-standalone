 ...
 */
//@MapperScan(basePackages = {"com.taotao.cloud.standalone.infrastructure.persistent.*.mapper"})
//@EnableJpaRepositories(
//	basePackages = {"com.taotao.cloud.standalone.infrastructure.persistent.*.repository.inf"},
...
public class TaoTaoCloudStandaloneApplication {
	...
	public static void main(String[] args) {
		new StartupSpringApplication(TaoTaoCloudStandaloneApplication.class)
			.setTtcBanner()
