...
package com.taotao.cloud.standalone.application.service.impl;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.taotao.cloud.standalone.application.command.dict.dto.DictDeleteCmd;
import com.taotao.cloud.standalone.application.command.dict.dto.DictGetQry;
import com.taotao.cloud.standalone.application.command.dict.dto.DictInsertCmd;
...
import com.taotao.cloud.standalone.application.command.dict.dto.DictUpdateCmd;
...
import com.taotao.cloud.standalone.application.command.dict.executor.DictDeleteCmdExe;
import com.taotao.cloud.standalone.application.command.dict.executor.DictInsertCmdExe;
import com.taotao.cloud.standalone.application.command.dict.executor.DictUpdateCmdExe;
import com.taotao.cloud.standalone.application.command.dict.executor.query.DictGetQryExe;
import com.taotao.cloud.standalone.application.command.dict.executor.query.DictListQryExe;
import com.taotao.cloud.standalone.application.command.dict.executor.query.DictOptionListQryExe;
import com.taotao.cloud.standalone.application.service.DictsService;
